...
public:
    ...
    __host__ __device__ friend inline float dot(const Vec3& v1, const Vec3& v2);
    __host__ __device__ friend inline Vec3 cross(const Vec3& v1, const Vec3& v2);
    __host__ __device__ friend inline Vec3 unit_vector(Vec3 v);
    ...
    __host__ __device__ friend inline Vec3 operator+(const Vec3& v1,
        const Vec3& v2);
    __host__ __device__ friend inline Vec3 operator-(const Vec3& v1,
        const Vec3& v2);
    __host__ __device__ friend inline Vec3 operator*(const Vec3& v1,
